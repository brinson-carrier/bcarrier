...
const Contact: React.FC<ContactProps> = ({ email, LI_URL }) => {
  return (
    <div className="flex items-center justify-center">
        <div className="relative h-20 w-full flex flex-col justify-end">
            <div className="flex-1 flex flex-col justify-end">
                <div className="w-full bg-blue-500 p-5 absolute bottom-0 h-20 flex flex-col justify-center">
                    <ul className="flex justify-center">
                        <li className='mx-6'>
                            <a href={`mailto:${email}`} className="text-white underline">{email}</a>
                        </li>
                        <li className='mx-6'>
                            <LIButton url={LI_URL} />
                        </li>
